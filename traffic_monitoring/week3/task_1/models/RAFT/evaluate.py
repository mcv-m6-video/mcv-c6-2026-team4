...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', help="restore checkpoint", default='/home-local/gasbert/master/C6/mcv-c6-2026-team4/traffic_monitoring/week3/models/RAFT/checkpoints/raft-kitti.pth')
