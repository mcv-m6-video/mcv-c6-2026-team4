...
# Preliminary hyperparameter search for adaptive model with Optuna
...
N_PROCESSES=4
N_TRIALS=100
SCRIPT="adaptive_model_hyperparameter_search.py"
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  1. Adaptive model without temporal (study: adaptive_no_temporal)"
            echo "  2. Adaptive model with temporal (study: adaptive_with_temporal)"
            echo ""
...
echo "=========================================="
echo "Adaptive Model Hyperparameter Search"
echo "=========================================="
...
run_study "adaptive_no_temporal" "false" "optuna_adaptive_no_temporal.db"

# Study 2: With temporal
run_study "adaptive_with_temporal" "true" "optuna_adaptive_with_temporal.db"
...
echo ""
echo "Results:"
echo "  - Adaptive (no temporal): optuna_adaptive_no_temporal.db"
echo "  - Adaptive (with temporal): optuna_adaptive_with_temporal.db"
echo ""
echo "To visualize results:"
echo "  optuna-dashboard sqlite:///optuna_adaptive_no_temporal.db"
echo "  optuna-dashboard sqlite:///optuna_adaptive_with_temporal.db"
echo ""
