...
class ActionSpotDataset(Dataset):
    ...
    def _store_clips(self):
        ...
        #Save to store
        store_path = os.path.join(self._store_dir, 'LEN' + str(self._clip_len) + 'STRIDE' + str(self._stride) + 'SPLIT' + self._split) #store clips information of dataset with LEN and SPLIT information
