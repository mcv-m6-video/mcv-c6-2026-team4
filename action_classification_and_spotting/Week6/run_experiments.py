...
Usage (from Week6/):
    python3 run_experiments.py --models phase1_gru_small phase1_gru_default phase1_gru_deep

    # Override GPUs
    python3 run_experiments.py --gpus 0 1 --models phase1_tcn_small phase1_tcn_default

    # Skip wandb + local file writes
    python3 run_experiments.py --dry-run --models phase1_gru_small
"""
...
def _run(model_name, gpu_id, gpu_queue, results, dry_run, log_dir):
    ...
    cmd = ['python3', 'main_spotting.py', '--model', model_name]
    if dry_run:
        cmd.append('--dry-run')
...
def main():
    ...
    parser.add_argument(
        '--models', nargs='+', type=str, required=True,
        metavar='NAME',
    ...
    parser.add_argument(
        ...
        metavar='SECONDS',
        help=f'Seconds between consecutive experiment starts to avoid '
